              ...
              {HeroData.map((data)=>(
                <div key={data.id}>
                  <div className='grid grid-cols-1 sm:grid-cols-2'>
                    ...
                    order-2 sm:order-1 relative z-0'>
                      <h1
                        data-aos="zoom-out"
                        data-aos-duration="500"
                        data-aos-once="true"
                       className='text-3xl sm:text-4xl lg:text-3xl font-bold'> {data.subtitle} </h1>
                      <h1
                        data-aos="zoom-out"
                        data-aos-duration="500"
                        data-aos-once="true"
                    ...
                    <div className='order-1 sm:order-2'>
                      <div data-aos="zoom-in" data-aos-once="true">
                        ...
                        sm:h[450px] sm:scale-105 lg:scale-120 object-contain
